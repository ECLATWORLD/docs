---
description: This tutorial will explain how to delegate/stake/unstake your ECLAT.
---

# Staking tutorial

Note: You can only stake ECLAT which is on Eclat network. Please make sure you have changed into Eclat network in Metamask while doing any transactions on staking UI. 

How to Stake Eclat:

**Step 1:**

Navigate to staking.eclatscan.com and login to your wallet through metamask. Make sure you are on Eclat network. If you are not please follow the instructions [**here**](https://docs.eclatscan.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
You will also see the APY on staking when you enter the amount of ECLAT you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 

![](../.gitbook/assets/3%20%286%29.png)

**How to Unstake ECLAT:**
