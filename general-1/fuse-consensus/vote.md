...
Eclat chain functionality can be change by voting on the contracts implementations. New implementations can be deployed, and opened to vote by validators for others to decide on whether to accept/reject the changes.

## Open a new ballot

In order to open a new vote, a validator needs to call the \`newBallot\` function on the [voting contract](https://eclatscan.com/address/0x2deC35c6f2EA9A3Ec3F264acf5e5050fC9f95043) with the following params:
...
Some other useful functions on the [voting contract](https://eclatscan.com/address/0x2deC35c6f2EA9A3Ec3F264acf5e5050fC9f95043) are:
