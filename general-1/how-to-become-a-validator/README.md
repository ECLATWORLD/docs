...
[Any entity that is holding the Eclat token can run a node](broken-reference) that approves transaction in the network and in doing so receive rewards in the form of Eclat token (ECLAT).
...
[You can delegate you Eclat token to a validator](broken-reference) of your choosing. Not everybody that wants to earn rewards need to be a validator! Any token holder can delegate their Eclat token to a validator to earn rewards through the validator.
