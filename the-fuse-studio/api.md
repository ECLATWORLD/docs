...
The Eclat Studio REST API for accessing the data and the services of the Eclat network in a simple way. You can use this API to query and interact with the objects of the Eclat network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and Eclat network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(Eclat\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the Eclat network |
...
| homeBridgeAddress | `String` | Bridge address on the Eclat network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the Eclat network |
...
Community is a set of contracts and services. Members of the community are users of the Eclat network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the Eclat network |
| homeTokenAddress | `String` | Address of the community token on the Eclat network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the Eclat network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the Eclat network |
...
Entity is an account on the Eclat network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on Eclat network |
